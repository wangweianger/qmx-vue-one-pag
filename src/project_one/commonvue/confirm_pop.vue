    ...
    <div class="prop-box" v-if="show">
        ...
        <div class="prop-mainbox" :style="{ width: defaultData.width + 'px'}">
            <div class="prop-title">
                <i :class="defaultData.icon"></i>
                <span class="prop-title-txt" v-text="defaultData.title"></span>
            ...
            <div class="prop-btn">
                <span class="a-btn" @click="comfig">确认</span>
                <span class="a-btn btom-close-btn" @click="closeBtn">取消</span>
            </div>
        </div>
    </div>
</template>
    ...
    data:function(){
        return {
            defaultData:{
                ...
                icon: this.options.icon || "icon-1",//标题图标
